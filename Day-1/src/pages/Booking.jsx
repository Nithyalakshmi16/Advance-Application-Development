import NavUser from '../body/navuser';
import Bookingimage from '../assets/picture/bookingimage.jpg';
    ...
    <div>
      ...
      <div className='containerpara'>
        <div className='conatain'>
          <p className='parabooking'>Here at Zin,. <br></br>we believe in balance. We believe in accessibility.
